...
if __name__ == '__main__':
  ...
  out = '/content/drive/My Drive/MCA/ass2/mfcc_train_X.pkl'
  outfile = open(out, 'wb')
  np.save(outfile, X_train)

  out = '/content/drive/My Drive/MCA/ass2/mfcc_train_Y.pkl'
  outfile = open(out, 'wb')
  np.save(outfile, Y_train)

  out = '/content/drive/My Drive/MCA/ass2/mfcc_val_X.pkl'
  outfile = open(out, 'wb')
  np.save(outfile, X_val)

  out = '/content/drive/My Drive/MCA/ass2/mfcc_val_Y.pkl'
  outfile = open(out, 'wb')
